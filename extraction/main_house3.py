...
def main():
	wiki_page = "https://en.wikipedia.org/wiki/List_of_House_members_of_the_38th_Parliament_of_Canada"
	options = Options()
	...
	WebDriverWait(driver,5).until(
		EC.presence_of_element_located((By.XPATH,"(//table[@style='border-collapse: collapse' and @width='610'])[1]")))
	tables_locator = "//table[@style='border-collapse: collapse' and @width='610']"
	...
	df = pd.DataFrame(df, columns = ["name", "party", "location"])
