...
def main():
	wiki_page = "https://en.wikipedia.org/wiki/List_of_House_members_of_the_40th_Parliament_of_Canada"
	options = Options()
	...
	WebDriverWait(driver,5).until(
		EC.presence_of_element_located((By.XPATH,"(//table[@class='wikitable sortable jquery-tablesorter'])[1]")))
	tables_locator = "//table[@class='wikitable sortable jquery-tablesorter']"
